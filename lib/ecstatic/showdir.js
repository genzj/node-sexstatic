...
module.exports = function (opts, stat, modify) {
      ...
      fs.readdir(dir, function (err, files) {
        ...
        function render(dirs, files, lolwuts) {
          ...
          html += '<br><address>Node.js ' +
            process.version +
            '/ <a href="https://github.com/gstack/node-sexstatic">sexstatic</a> ' +
            'server running @ ' +
          ...
          if (!failed) {
            ...
            for (var i=0;i<opts.modifyFunctions.length;i++)
            {
              html = opts.modifyFunctions[i](html);
            }
